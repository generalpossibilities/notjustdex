...
class MiniAppRegistry extends ChangeNotifier {
  ...
  static final List<MiniApp> _available = [
    MiniApp(
      ...
      iconUrl: 'https://notjustdex.io/miniapps/wallet/icon.png',
      entryUrl: 'https://notjustdex.io/miniapps/wallet/',
      developer: 'NotJustDex',
    ...
    MiniApp(
      ...
      iconUrl: 'https://notjustdex.io/miniapps/dao/icon.png',
      entryUrl: 'https://notjustdex.io/miniapps/dao/',
      developer: 'NotJustDex',
    ...
    MiniApp(
      ...
      iconUrl: 'https://notjustdex.io/miniapps/creator/icon.png',
      entryUrl: 'https://notjustdex.io/miniapps/creator/',
      developer: 'NotJustDex',
    ...
    MiniApp(
      ...
      iconUrl: 'https://notjustdex.io/miniapps/market/icon.png',
      entryUrl: 'https://notjustdex.io/miniapps/market/',
      developer: 'NotJustDex',
      requiredPermissions: [MiniAppPermission.identity, MiniAppPermission.wallet, MiniAppPermission.payments],
    ),
    MiniApp(
      ...
      iconUrl: 'https://notjustdex.io/miniapps/games/icon.png',
      entryUrl: 'https://notjustdex.io/miniapps/games/',
      developer: 'NotJustDex',
