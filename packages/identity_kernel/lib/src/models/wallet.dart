...
/// Acki Nacki MPC Wallet
///
/// Uses 2-of-3 threshold signature scheme:
/// - Share 1: Device (phone secure enclave)
/// - Share 2: Cloud backup (encrypted)
/// - Share 3: Paper wallet (24-word seed phrase)
///
/// Seed phrase can be rotated (unique Acki Nacki feature).
@freezed
...
/// 24-word BIP-39 style seed phrase for Acki Nacki.
class SeedPhrase {
  final List<String> words;
  final int version;

  const SeedPhrase({required this.words, this.version = 1});

  /// BIP-39 wordlist (2048 words) — using a subset for demo
  static const _wordlist = [
    'abandon', 'ability', 'able', 'about', 'above', 'absent',
    'absorb', 'abstract', 'absurd', 'abuse', 'access', 'accident',
    'account', 'accuse', 'achieve', 'acid', 'acoustic', 'acquire',
    'across', 'act', 'action', 'actor', 'actress', 'actual',
    'adapt', 'add', 'address', 'adjust', 'admit', 'adopt',
    'advance', 'advantage', 'adventure', 'affair', 'afford', 'afraid',
    'after', 'again', 'age', 'agent', 'agree', 'ahead',
    'aim', 'air', 'airport', 'alarm', 'album', 'alert',
    'alien', 'align', 'alive', 'all', 'allow', 'almost',
    'alone', 'along', 'already', 'also', 'alter', 'always',
    'amaze', 'among', 'amount', 'ample', 'anchor', 'ancient',
    'angle', 'animal', 'ankle', 'announce', 'annual', 'another',
    'answer', 'antenna', 'antique', 'anxiety', 'any', 'apart',
    'apology', 'appear', 'apple', 'approve', 'april', 'arch',
    'arctic', 'area', 'arena', 'argue', 'arm', 'armor',
    'army', 'around', 'arrange', 'arrest', 'arrive', 'arrow',
    'art', 'aspect', 'assault', 'asset', 'assist', 'assume',
    ...
    'below', 'belt', 'bench', 'benefit', 'best', 'better',
    ...
    'canal', 'cancel', 'candle', 'candy', 'cannon', 'canoe',
    ...
    'cook', 'cool', 'copper', 'copy', 'coral', 'core',
    'corn', 'correct', 'cost', 'cotton', 'couch', 'country',
    'couple', 'course', 'cousin', 'cover', 'coyote', 'crack',
    ...
    'december', 'decide', 'decline', 'decorate', 'decrease',
    'deer', 'defense', 'define', 'defy', 'degree', 'delay',
    'deliver', 'demand', 'demise', 'denial', 'dentist', 'deny',
    'depart', 'depend', 'deposit', 'depth', 'deputy', 'derive',
    'describe', 'desert', 'design', 'desk', 'despair', 'destroy',
    'detail', 'detect', 'develop', 'device', 'devote', 'diagram',
    'dial', 'diamond', 'diary', 'dice', 'diesel', 'diet',
    'differ', 'digital', 'dignity', 'dilemma', 'dinner', 'dinosaur',
    'direct', 'dirt', 'disagree', 'discover', 'disease', 'dish',
    'dismiss', 'display', 'distance', 'divert', 'divide', 'divorce',
    ...
    'example', 'exceed', 'excel', 'except', 'excerpt', 'excite',
    ...
    'october', 'odor', 'off', 'offense', 'offer', 'office',
    ...
    'output', 'outside', 'oval', 'oven', 'over', 'own',
    'owner', 'oxygen', 'oyster', 'ozone', 'pact', 'paddle',
    'page', 'pair', 'palace', 'palm', 'panda', 'panel',
    'panic', 'panther', 'paper', 'parade', 'parent', 'park',
    'parrot', 'party', 'pass', 'patch', 'path', 'patient',
    'patrol', 'pattern', 'pause', 'pave', 'payment', 'peace',
    'peanut', 'pear', 'peasant', 'pelican', 'pen', 'penalty',
    'pencil', 'people', 'pepper', 'perfect', 'permit', 'person',
    'pet', 'phone', 'photo', 'phrase', 'physical', 'piano',
    'picnic', 'picture', 'piece', 'pig', 'pigeon', 'pill',
    'pilot', 'pink', 'pioneer', 'pipe', 'pistol', 'pitch',
    'pizza', 'place', 'planet', 'plastic', 'plate', 'play',
    'player', 'please', 'pledge', 'pluck', 'plug', 'plunge',
    ...
    'proposal', 'protect', 'protein', 'protest', 'proud', 'prove',
    ...
    'steep', 'steer', 'stem', 'step', 'stereo', 'stick',
    ...
    'sugar', 'suggest', 'suit', 'sun', 'sunny', 'sunset',
    'super', 'supply', 'support', 'suppose', 'sure', 'surface',
  ...
  static SeedPhrase generate() {
    final random = DateTime.now().microsecondsSinceEpoch;
    final words = <String>[];
    for (var i = 0; i < 24; i++) {
      final index = (random + i * 7919) % _wordlist.length;
      words.add(_wordlist[index]);
    }
    return SeedPhrase(words: words);
  }

  /// Rotate to a new seed phrase (increment version).
  SeedPhrase rotate() {
    final newWords = <String>[];
    final random = DateTime.now().microsecondsSinceEpoch;
    for (var i = 0; i < 24; i++) {
      final index = (random + version * 104729 + i * 7919) % _wordlist.length;
      newWords.add(_wordlist[index]);
    }
    return SeedPhrase(words: newWords, version: version + 1);
  }
